...
const RequestDemo = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      inquiryType: formData.hearAbout || "Demo Request",
        ...
        <div className="demo-grid">
          ...
          <div className="demo-left">
            <div>
              ...
              <p className="demo-main-description">
                Discover how our platform can transform your CompliSense workflows.
          ...
          <div className="demo-form-container">
            ...
            <form onSubmit={handleSubmit} className="demo-form">
              ...
              {submitted && (
                <div className="mt-4 p-3 bg-green-50 text-green-800 rounded-md text-center border border-green-200">
